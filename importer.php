...
function getWoocommerceConfig()
{
    ...
    $woocommerce = new Client(
        'http://homework.loc/',
        'ck_d802d157cb81ea8113b7b6a2c951e4b554512573',
        'cs_1a3c9773d0d4460be838d3e6a00c412b237b6703',
        [
            'wp_api' => true,
            'version' => 'wc/v3',
...
require_once plugin_dir_path(__FILE__) . 'public/class-wpsync-webspark-public.php';

function getArrayFromUrl()
{
    $plugin_name = 'wpsync-webspark';
    $wpsync_webspark_options = get_option($plugin_name);

    $url = $wpsync_webspark_options['footer_text'];
...
function checkProductBySku($skuCode)
{
    ...
    foreach ($products as $product) {
        ...
        if ($currentSku === $skuCode) {
            ...
            wp_delete_post($product->get_sku());
